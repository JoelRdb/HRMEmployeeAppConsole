...
namespace BethanysPieShopHRMEmployeeApp
{
    ...
    public class Programm
    {
        ...
        private static void RegisterEmployee()
        {
            ...
            double rate = double.Parse(hourlyRate); //we will assume here that uinput is in the correct format
        ...
        private static void RegisterWork()
        {
            ...
            int selection = int.Parse(Console.ReadLine()); //we will assume here taht a valid ID is selected
            ...
            Console.WriteLine($"{selectedEmployee.FirstName} {selectedEmployee.LastName} has now worked {numberOfHoursWorked}" +
                $"hours in total.\n\n");
        }
